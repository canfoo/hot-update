...
function log(type, content) {
    if (type === 'success') {
        console.log(`${chalk.green.bold('SUCESS:')} ${chalk.green(content)}`)
    } else if (type === 'warning') {
        console.log(`${chalk.yellow.bold('WARNING:')} ${chalk.yellow(content)}`)
    } else if (type === 'error') {
        console.log(`${chalk.red.bold('ERROR:')} ${chalk.red(content)}`)
    }
}
